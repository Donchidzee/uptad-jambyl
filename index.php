<?php
    ...
    if(isset($_COOKIE['lang']) && $_COOKIE['lang'] === 'kz') {
        ...
        $tpl->set_values('TITLE', 'Жамбыл облысының әкімділігі және автокөлік жолдарының басқармасы');
        $tpl->set_values('DESC', 'Жамбыл облысының әкімділігі және автокөлік жолдарының басқармасы');
    } else {
        ...
        $tpl->set_values('DESC', 'Управление пассажирского транспорта и автомобильных дорог акимата Жамбылской области');
    }
